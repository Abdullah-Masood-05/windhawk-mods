...
v3.1.0 are his as well (from v1.5 of his engine): the translucent-window capture
...
- Translucent (acrylic / Mica) windows are captured much more faithfully as of
  v3.1.0 - transparent regions now stay transparent instead of turning grey - but
...
- Minimize snapshots are captured from the window itself, so the taskbar and other
  ...
  Since v3.1.0 the capture preserves per-pixel transparency (Potassiumuncher's
